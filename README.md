...
them to the user. In a project with `.harness.json`, at session start, the sync hook generates
the Git hooks it lists and, with `"statusLine": true`, the status-line hook installs the
